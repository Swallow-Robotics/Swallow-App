...
const Header = ({ activeTopTab, setActiveTopTab }) => {
  const { user } = useAuth();
      ...
      <div className="App-header__inner">
        <div className="App-header__left">
          ...
          <div className="App-header__tabs">
            <button
              type="button"
              className={`App-header__tab ${activeTopTab === 'view' ? 'App-header__tab--active' : ''}`}
              onClick={() => setActiveTopTab('view')}
            >
              View
            </button>
            <button
              type="button"
              className={`App-header__tab ${activeTopTab === 'fly' ? 'App-header__tab--active' : ''}`}
...
export function AppRoutes() {
  ...
  const [activeTopTab, setActiveTopTab] = useState('view');

  useEffect(() => {
    if (location.pathname === '/fly') setActiveTopTab('fly');
  }, [location.pathname]);
  ...
  return (
    <div className="App">
      {showHeader && (
        <Header activeTopTab={activeTopTab} setActiveTopTab={setActiveTopTab} />
      )}
      {showHeader && activeTopTab === 'view' && <SecondaryNav />}
