...
const UploadPlanModal = ({
  ...
  // Do NOT include projectCenter in deps: it changes when projects refresh (e.g. from
  // AuthContext retry logic), which would tear down and recreate the map, wiping markers.
  const initialCenter = projectCenter
